...
'''Twitter bot to respond, "This is also a wrap."'''
...
def get_mentions(output):
    ...
    for status in statuses:
        ...
        # To filter out tweets that only have 'wrap' because of a URL
        if 'wrap' in status['text']:
